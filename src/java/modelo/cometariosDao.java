...
public class cometariosDao {
    ...
    public int insertarcomentario(comentarios com){
        ...
        try {
            ...
            ps.setInt(1, com.getCod_Comentario());
            ps.setInt(2, com.getId_Usuario());
            ps.setString(3, com.getFecha_Comentario());
    ...
    public boolean actualizarcomentario(comentarios comactu){
        ...
        try {
            ...
            ps.setInt(1, comactu.getId_Usuario());
            ps.setString(2, comactu.getFecha_Comentario());
            ps.setString(3, comactu.getComentario());
            ps.setInt(4, comactu.getCod_Comentario());
