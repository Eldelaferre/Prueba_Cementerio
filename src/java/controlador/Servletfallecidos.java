 ...
 * @author jonat
 */
@WebServlet(name = "Servletfallecidos", urlPatterns = {"/Servletfallecidos"})
public class Servletfallecidos extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("btninsF")!=null){
            ...
            del.setAttribute("CodigoF",cod);
            response.sendRedirect("deceased.jsp");
        }
        else{
